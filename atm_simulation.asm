...
DATA SEGMENT
    ...
    LIM_EXCEED DB 0AH, 0AH, 0DH, " Limit Exceeded (Maximum Amount = 5000 Tk )$"
    ...
    ;Amount options
    ABOVE1000 DB 0AH, 0AH, 0DH, " 1. 1000 Tk - 5000 Tk$"
    ABOVE100 DB 0AH, 0DH, " 2. 100 Tk - 999 Tk$" 
    MAX_LIM DW 5000
    MIN_LIM DW 100
...
CODE SEGMENT
    ...
    WITHDRAW:
        ...
        ;If withdrawal amount is between 1000Tk and 5000Tk
        WITH_ABOVE1000:
            MOV AH, 09H
            LEA DX, WITH_PROMPT
            INT 21H
            ...
            ;If withdrawal amount is between 100Tk and 999Tk
            WITH_ABOVE100: 
                   MOV AH, 09H
                   LEA DX, WITH_PROMPT
                   INT 21H
        ...
        ;If deposit amount is between 1000Tk and 5000tk
        DEP_ABOVE1000: 
                   MOV AH, 09H
                   LEA DX, DEP_PROMPT
                   INT 21H
        ...
        ;If deposit amount is between 100Tk and 999Tk
        DEP_ABOVE100: 
                  MOV AH, 09H
                  LEA DX, DEP_PROMPT
                  INT 21H
